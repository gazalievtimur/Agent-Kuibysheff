...
param(
    ...
    # Agent Kuibysheff install (binary / optional monorepo); default = parent of scripts/
    [string] $RepoRoot = "",

    # 1C workflow copy unit (prompts/adapters/products); default = RepoRoot/workflows/1c-dev
    [string] $WorkflowRoot = ""
)
...
$agentProfiles = @{
    "1" = @{ Id = "1c-intake"; Prompt = "prompts/stage1.intake.md" }
    "2" = @{ Id = "1c-analyst"; Prompt = "prompts/stage2.analysis.md" }
    "3" = @{ Id = "1c-coder"; Prompt = "prompts/stage3.coder.md" }
    "4" = @{ Id = "1c-implementer"; Prompt = "prompts/stage4.implement.md" }
}
...
if (-not (Test-Path -LiteralPath $productPath -PathType Leaf)) {
    ...
    $fallback = Join-Path $workflowRoot "products\$Product.yaml"
