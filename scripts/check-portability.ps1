...
try {
    ...
    Write-Host "== static absolute-path gate (tracked configs + VS Code examples) =="
    ...
    Write-Host "ok: no disallowed absolute paths in tracked agent/product/VS Code configs"
